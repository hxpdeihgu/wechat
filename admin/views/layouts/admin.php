...
<div id="float" class="folat" style="display: block;">
    <div class="sk-wave">
...
<div class="wrap">
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => Yii::$app->session->get('user_name')?Yii::$app->session->get('user_name'):'','options' => ['style'=>'border-right: 1px solid #54698e;'],'items' => [
